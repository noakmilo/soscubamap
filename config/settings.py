...
class Config:
    ...
    PROTEST_FETCH_TIMEOUT_SECONDS = int(os.getenv("PROTEST_FETCH_TIMEOUT_SECONDS", "30"))
    ...
    PROTEST_MIN_CONFIDENCE_TO_SHOW = float(os.getenv("PROTEST_MIN_CONFIDENCE_TO_SHOW", "35"))
